...
function activate(context) {
	...
	const aCA = vscode.commands.registerCommand('arorashivoy.touchBar.addCursorAbove', function () {
		addCursor('above')
	})
	const aCB = vscode.commands.registerCommand('arorashivoy.touchBar.addCursorBelow', function () {
		addCursor('below')
	})

	vscode.commands.registerCommand('arorashivoy.touchBar.closeGroup', function () {
		...
		// vscode.workspace.getConfiguration().update('arorashivoy-touchBar.enabledGroup', 0)
	})
	vscode.commands.registerCommand('arorashivoy.touchBar.enableFuncGroup', function () {
		...
		// vscode.workspace.getConfiguration().update('arorashivoy-touchBar.enabledGroup', 1)
	})
	vscode.commands.registerCommand('arorashivoy.touchBar.enableSrcGroup', function () {
		vscode.commands.executeCommand('setContext', 'enabledGroup', true)
		vscode.commands.executeCommand('setContext', 'enabledSrcGroup', true)
		// vscode.workspace.getConfiguration().update('arorashivoy-touchBar.enabledGroup', 2)
	})
	vscode.commands.registerCommand('arorashivoy.touchBar.enableEditorGroup', function () {
		vscode.commands.executeCommand('setContext', 'enabledGroup', true)
		vscode.commands.executeCommand('setContext', 'enabledEditorGroup', true)
		// vscode.workspace.getConfiguration().update('arorashivoy-touchBar.enabledGroup', 3)
	})
	vscode.commands.registerCommand('arorashivoy.touchBar.enableCursorsGroup', function () {
		vscode.commands.executeCommand('setContext', 'enabledGroup', true)
		vscode.commands.executeCommand('setContext', 'enabledCursorsGroup', true)
		// vscode.workspace.getConfiguration().update('arorashivoy-touchBar.enabledGroup', 4)
	})

	// ADDING run-code for code-runner
	vscode.commands.registerCommand('arorashivoy.touchBar.runCode', function () {
		vscode.commands.executeCommand('code-runner.run')
	})

	vscode.commands.registerCommand('arorashivoy.touchBar.goToDefinition', function () {
